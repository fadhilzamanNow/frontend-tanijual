...
const Hero = () => {
  return (
    <div
      className={`relative min-h-[120vh] 800px:min-h-[100vh] w-full ${styles.noramlFlex}`}
      style={{
        backgroundImage: `url(${require("../../../Assests/Home/Vegetable-HD-Desktop-Wallpaper-62231.jpg")})`,
        backgroundSize : "cover",
        backgroundPosition :"center"
        
      }}
    >
            <div className={`${styles.section} w-[90%] 800px:w-[60%] mb-[550px]`}>
                <h1 className={`mt-20 text-[35px] leading-[1.2] 800px:text-[60px] font-[800] capitalize text-green-600`}>
                    Produk Segar <br/>
                    <p className="text-white">Buah Buahan dan Sayur Sayuran</p>
                </h1>
                <p className="pt-5 text-[16px] font-[Poppins] font-[600] text-justify mt-[80px] flex flex-col gap-y-8 text-white" >
