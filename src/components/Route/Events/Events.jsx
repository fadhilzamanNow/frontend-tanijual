            ...
            <div className=" 200px:h-80 sm:h-84 sm:h-80 w-full">
              <Carousel pauseOnHover={false} slide={false}>
                ...
                <div className='bg-green-400 w-full h-full flex justify-between items-center font-Poppins' onClick={() => navigate("/events")}>
                    <div className="text-[52px] sm:text-[68px] md:text-[84px] lg:text-[102px] xl:text-[110px] xl:w-[50%] 2xl:text-[140px] 2xl:w-[50%] xl:mt-0 font-[600]  text-white w-[50%] text-center">
                        Buah Banjir
                    </div>
                ...
                <div className="bg-yellow-900  w-full h-full flex justify-around items-center font-Poppins" onClick={() => navigate("/events")}>
                  <h1 className="text-[52px] sm:text-[68px] md:text-[84px] lg:text-[102px] xl:text-[110px] xl:w-[50%] 2xl:text-[140px] 2xl:w-[50%] xl:mt-0 font-[600]  text-white w-[50%] text-center">
                      Pupuk Murah
                  </h1>
                  <div className="w-[50%] flex justify-center">
