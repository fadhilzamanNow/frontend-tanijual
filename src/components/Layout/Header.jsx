...
const Header = ({ activeHeading }) => {
  ...
  return (
    <div>
      <div className={``}>
        <div className="hidden 800px:h-[50px] 800px:py-10 800px:px-10 800px:flex items-center justify-between bg-white">
          ...
          <div
            className={`flex flex-row  h-[45px] w-[200px] ${isSeller ? "bg-black" : "bg-green-500"} items-center justify-center rounded-md`}
          >
            {isSeller ? (
              <Link
                to="/dashboard"
                className="flex flex-1 flex-row items-center justify-evenly"
              >
                <h1 className="text-white">Cek Dashboard Penjual</h1>
              ...
              <Link
                ...
                className="flex flex-1 flex-row items-center justify-evenly"
              >
                <h1 className="text-white">Masuk Sebagai Penjual</h1>
                <IoIosArrowForward className="text-green-100 mt-1" size={16} />
              </Link>
            )}
          </div>
      ...
      <div
        className={`${active === true ? "shadow-sm fixed top-0 left-0 z-10" : null} transition hidden 800px:flex item-center justify-between w-full bg-green-500 h-[70px] overflow-visible`}
      >
        <div
          className={`${styles.section} relative ${styles.noramlFlex} justify-between overflow-visible`}
        >
          {/* categories */}
          <div className="overflow-visible">
            <div className="relative h-[60px] mt-[10px] mb-[10px] w-[270px] hidden 1000px:block text-white overflow-visible">
              <BiMenuAltLeft
                size={30}
              ...
              <IoIosArrowDown
                size={20}
                className="absolute right-2 top-[23px] cursor-pointer text-white"
              />
    ...
    <div className={`${active === true ? "shadow-sm fixed top-0 left-0 z-10" : null} transition hidden 800px:flex item-center justify-between w-full bg-green-500 h-[70px]`}>
      ...
      <div
        className={`${active === true ? "shadow-sm fixed top-0 left-0 z-10" : null} w-full h-[70px] fixed bg-[#fffefe] z-50 top-0 left-0 shadow-sm 800px:hidden items-center flex justify-center`}
      >
        <div className="w-full flex items-center justify-between">
          ...
          <div className="flex">
            <div
              ...
              onClick={() => setOpenCart(true) || console.log("ddipencet")}
            >
